...
const testimonials = [
  {
    ...
    location: "Lagos",
    rating: 5,
    text: "The Jimpo-Ori Shea Butter transformed my baby's skin. So smooth and gentle — I use it every day!",
  },
  {
    name: "Blessing A.",
    location: "Abuja",
    rating: 5,
    text: "The Black Soap is incredible! My dark spots have faded significantly in just 3 weeks. Highly recommend.",
  },
  {
    name: "Chioma E.",
    location: "Port Harcourt",
    rating: 4,
    text: "I bought the full collection as a gift and the packaging was beautiful. Premium quality at a great price.",
  },
];
...
const Index = () => {
  ...
  return (
    <main>
        ...
        <div className="grid grid-cols-1 items-center gap-10 md:grid-cols-2">
          ...
          >
            ...
            <p className="text-muted-foreground leading-relaxed">
              From nourishing shea butters to premium black soaps and essential oils — our collection covers every step of your beauty routine. All products are NAFDAC approved and made with 100% natural ingredients.
            </p>
            <div className="flex flex-wrap gap-3 pt-2">
              <Link
                to="/products"
                className="inline-flex items-center gap-2 rounded-full bg-gradient-gold px-6 py-3 text-sm font-medium text-primary-foreground hover:opacity-90 transition-opacity"
              >
          ...
          <div className="grid grid-cols-1 items-center gap-10 md:grid-cols-2">
            ...
            >
              ...
              <h2 className="font-display text-2xl font-bold md:text-3xl">
                Deeply Nourishing Care <br />
                <span className="text-gradient-gold">For Glowing Skin</span>
              </h2>
              <p className="text-muted-foreground leading-relaxed">
                Our formulas harness the power of organic shea butter, essential oils, and African black soap to deliver transformative results — naturally.
              </p>
              <div className="grid grid-cols-2 gap-4 pt-2">
                ...
                <div className="flex items-center gap-2">
                  <CheckCircle size={16} className="text-primary shrink-0" />
                  <span className="text-sm font-medium">Sulphate-Free</span>
                </div>
                <div className="flex items-center gap-2">
                  <CheckCircle size={16} className="text-primary shrink-0" />
              ...
              <Link
                to="/products"
                className="inline-flex items-center gap-2 rounded-full bg-gradient-gold px-6 py-3 text-sm font-medium text-primary-foreground hover:opacity-90 transition-opacity mt-4"
              >
                Shop Now <ArrowRight size={14} />
              </Link>
            </motion.div>
            ...
            >
              <img
                src="/images/black-soap.jpeg"
                alt="Premium Black Soap"
                className="rounded-3xl shadow-[var(--shadow-elevated)] w-full max-w-md mx-auto"
              />
            </motion.div>
          </div>
        </div>
      ...
      {/* Beauty Care Products - Category Tabs */}
      <section className="container py-16 md:py-24">
          ...
          <div className="grid grid-cols-1 gap-6 md:grid-cols-3">
            {testimonials.map((t, i) => (
              <motion.div
                ...
                className="rounded-2xl bg-background p-6 shadow-[var(--shadow-card)] space-y-4"
              >
      ...
      <section className="container py-16 md:py-24 text-center max-w-2xl mx-auto">
        ...
        >
          ...
          <p className="text-muted-foreground leading-relaxed">
            Every product is thoughtfully formulated with the finest natural ingredients —
            from organic shea butter and essential oils to African black soap. We believe luxury should be
